...
def _clean_realtime_stock_name(value: Any) -> str:
    ...
    if not name:
        return ""
    name = re.sub(r"^(?:XD|XR|DR)(?=[\u4e00-\u9fff])", "", name, flags=re.IGNORECASE).strip()
    # Some domestic quote feeds insert spaces inside short names, e.g. "万  科A".
    # Collapse whitespace when the quote name is clearly a compact stock name,
    # while leaving longer company/profile text untouched.
    if len(name) <= 12 and re.search(r"[\u4e00-\u9fff]", name):
...
_HIGH_GROWTH_INDUSTRY_CLUSTERS: tuple[Dict[str, Any], ...] = (
    {
        ...
        "roles": (
            ...
            ("执行与热管理", ("机器人执行器", "执行器", "电动执行器", "滚珠丝杠", "丝杠", "伺服系统", "伺服电机", "热管理", "汽车热管理")),
            ("控制算法", ("运动控制", "运动控制器", "强化学习", "slam", "任务规划", "具身语义", "plc", "变频器", "工业自动化", "控制系统")),
        ),
        "moat_terms": ("量产", "客户认证", "精密制造", "控制算法", "核心零部件", "供应链", "专利", "车规", "定点", "平台化"),
    },
    {
        "label": "AI算力与先进半导体",
        "base_space": 0.96,
        ...
        "roles": (
            ...
            ("AI软件/端侧智能", ("ai办公", "办公软件", "saas", "企业服务", "云计算", "云服务", "ai云", "大模型服务", "端侧ai", "边缘ai", "智能操作系统", "智能座舱", "智能汽车")),
        ),
    ...
    },
    {
        ...
        "roles": (
            ("垂直Agent", ("ai智能体", "智能体", "agent", "ai应用", "智能语音", "认知智能", "多模态", "教育ai", "ai办公", "企业服务", "saas", "云计算", "云服务", "ai云", "通义千问", "文心一言", "混元", "智能客服")),
            ("平台型AI应用", ("ai电商", "电商", "即时零售", "本地生活", "直播电商", "短视频", "内容平台", "搜索", "搜索引擎", "大模型应用")),
            ("端侧/行业AI应用", ("端侧ai", "边缘ai", "智能操作系统", "智能座舱", "智能汽车", "智能硬件", "aiot", "物联网", "小米汽车", "无人配送", "办公软件", "数字娱乐", "游戏", "社交")),
...
_STRATEGIC_GROWTH_COMPANY_HINTS: tuple[Dict[str, Any], ...] = (
    ...
    {
        "matches": ("002050", "三花智控"),
        "terms": "机器人执行器 汽车热管理 热管理 新能源汽车 人形机器人 核心零部件 客户定点 平台化",
    },
    {
        "matches": ("300124", "汇川技术"),
        "terms": "工业自动化 伺服系统 变频器 PLC 运动控制器 机器人 新能源汽车 电控 国产替代",
    },
    {
        "matches": ("9988", "HK9988", "阿里巴巴"),
        "terms": "云计算 阿里云 通义千问 大模型应用 AI电商 企业服务 平台生态 AI智能体",
    },
    {
        "matches": ("1810", "HK1810", "小米集团"),
        "terms": "智能硬件 AIoT 物联网 小米汽车 智能座舱 端侧AI 机器人 消费电子生态",
    },
    {
        "matches": ("9888", "HK9888", "百度"),
        "terms": "人工智能 大模型 文心一言 Apollo 自动驾驶 AI云 搜索引擎 智能体",
    },
    {
        "matches": ("9618", "HK9618", "京东"),
        "terms": "供应链 数智化 物流自动化 AI零售 云服务 电商 平台生态 智能仓储",
    },
    {
        "matches": ("3690", "HK3690", "美团"),
        "terms": "本地生活 即时零售 AI调度 无人配送 机器人 平台生态 消费服务数字化",
    },
    {
        "matches": ("1024", "HK1024", "快手"),
        "terms": "短视频 直播电商 内容平台 AIGC 多模态 推荐算法 AI应用",
    },
)
